...
| Q22 | Portfolio breadth & sizing defaults? | DECIDED (round 2) | Multi-symbol portfolio from day one; target-percent-of-equity sizing; default capital $100k and default limits (25% position / 100% gross / 20% drawdown) in config | ADR-0006, ADR-0007, PLAN §Assumed defaults |
